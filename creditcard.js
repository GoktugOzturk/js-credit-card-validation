...
function checkCreditCard(cardNumber, cardName) {
  ...
  var cards = {
    amex:{digits:[15], prefix:"3[47]", luhn:true},
    unionpay:{digits:[16,17,18,19], prefix:"62", validate:false},
    carteblanche:{digits:[14], prefix:"30[0-5]", luhn:true},
    dinersclub:{digits:[14], prefix:"36", luhn:true},
    discover:{digits:[16], prefix:"(6011|622|64[4-9]|65)", luhn:true},
    instapayment:{digits:[16], prefix:"63[7-9]", luhn:true},
    jcb:{digits:[16], prefix:"35(2[89]|[3-8])", luhn:true},
    laser:{digits:[16,17,18,19], prefix:"(6304|670[69]|6771)", luhn:true},
    maestro:{digits:[12,13,14,15,16,17,18,19], prefix:"(5018|5020|5038|6304|6759|676[1-3])", luhn:true},
    mastercard:{digits:[16], prefix:"5[1-5]", luhn:true},
    visa:{digits:[16], prefix:"4", luhn:true},
    electron:{digits:[16], prefix:"(4026|417500|4508|4844|491[37])", luhn:true}
  };
